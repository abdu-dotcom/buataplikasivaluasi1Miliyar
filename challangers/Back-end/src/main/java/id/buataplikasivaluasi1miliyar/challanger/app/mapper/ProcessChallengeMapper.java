...
import id.buataplikasivaluasi1miliyar.challanger.app.dto.UserChallengeProgressDto;
...
public interface ProcessChallengeMapper {
    ...
    StartChallengeDto toDto(UserChallengeProgress userChallengeProgress);
    ...
    UserChallengeProgress toEntity(StartChallengeDto startChallengeDto);
